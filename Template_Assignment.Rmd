...
author: "Marnix Kuil 2900391, Peter Simon Lamers 2894404,Sophie Valckx 2905390, Thijmen Gerritsen 2787153, Thomas" 
date: "2026-06-23"
output: pdf_document
---
...
ggplot(cleaned_pollution_data, aes(x=year, y=`Air Pollution Population Weighted Average [ug/m3]`)) + 
  ...
  labs(
    title = "Temporal Variation of Air Pollution",
...
map_data_clean <- cleaned_pollution_data %>%
  filter(
    year == 2023, # single year to visualize on the map
  )
...
### Analysis of the subpopulation variation
