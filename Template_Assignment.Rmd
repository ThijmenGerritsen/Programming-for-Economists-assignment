...
#dataset <- midwest
library(readr)
DataExtract2 <- read_delim("data/DataExtract2.csv", 
...
The variables we used do contain both health information and SES information, 
...
```{r}
# create data
xValue <- combined_data$year
yValue <- combined_data$affected_population
#data <- combined_data(xValue, yValue)

require(ggplot2)
#plot
ggplot(combined_data, aes(x=xValue, y=yValue)) + geom_line()
